...
const FromSocialCookie = useCookie('FromSocial');
const roleCookie = useCookie('role');
const authkeyCookie = useCookie('authkey');
...
const logout = async (): Promise<void> => {
  try {
    const response = await fetch(
      `${apiUrl}/member/logout?email=${emailCookie.value}`,
      {
        method: 'GET',
  ...
  <div>
    <form class="WriteForm">
      ...
      <div id="RegistryForm">
        ...
        <input type="text" class="input_field" :value="emailCookie" readonly /><br />
